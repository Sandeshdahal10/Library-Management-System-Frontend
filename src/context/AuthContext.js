...
export function AuthProvider({ children }) {
  ...
  /**
   * login
   *  Persist and set auth data after a successful login.
   * - Parameters:
   ...
   *  Removes token and user from localStorage and resets state to null.
   */
  const logout = () => {
...
/**
 * useAuth 
 *  Returns the context value provided by AuthProvider.
 */
